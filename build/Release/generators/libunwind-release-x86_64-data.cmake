...
list(APPEND libunwind_COMPONENT_NAMES libunwind::unwind libunwind::generic libunwind::setjmp libunwind::ptrace libunwind::coredump)
list(REMOVE_DUPLICATES libunwind_COMPONENT_NAMES)
if(DEFINED libunwind_FIND_DEPENDENCY_NAMES)
  list(APPEND libunwind_FIND_DEPENDENCY_NAMES LibLZMA ZLIB)
  list(REMOVE_DUPLICATES libunwind_FIND_DEPENDENCY_NAMES)
else()
  set(libunwind_FIND_DEPENDENCY_NAMES LibLZMA ZLIB)
endif()
...
########### VARIABLES #######################################################################
#############################################################################################
set(libunwind_PACKAGE_FOLDER_RELEASE "/home/ferdi/.conan2/p/b/libund14f46885d750/p")
...
set(libunwind_LIBS_RELEASE unwind-coredump unwind-ptrace unwind-setjmp unwind-generic unwind)
...
set(libunwind_COMPONENTS_RELEASE libunwind::unwind libunwind::generic libunwind::setjmp libunwind::ptrace libunwind::coredump)

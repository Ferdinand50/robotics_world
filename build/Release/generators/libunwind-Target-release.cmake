...
########## COMPONENTS TARGET PROPERTIES Release ########################################
    ...
    ########## COMPONENT libunwind::coredump #############
        ...
        set_property(TARGET libunwind::coredump APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_coredump_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET libunwind::coredump APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${libunwind_libunwind_coredump_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET libunwind::coredump APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${libunwind_libunwind_coredump_LIB_DIRS_RELEASE}>)
        set_property(TARGET libunwind::coredump APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_coredump_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET libunwind::coredump APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_coredump_COMPILE_OPTIONS_RELEASE}>)
    ...
    ########## COMPONENT libunwind::ptrace #############
        ...
        set_property(TARGET libunwind::ptrace APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_ptrace_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET libunwind::ptrace APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${libunwind_libunwind_ptrace_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET libunwind::ptrace APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${libunwind_libunwind_ptrace_LIB_DIRS_RELEASE}>)
        set_property(TARGET libunwind::ptrace APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_ptrace_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET libunwind::ptrace APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_ptrace_COMPILE_OPTIONS_RELEASE}>)
    ...
    ########## COMPONENT libunwind::setjmp #############
        ...
        set_property(TARGET libunwind::setjmp APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_setjmp_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET libunwind::setjmp APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${libunwind_libunwind_setjmp_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET libunwind::setjmp APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${libunwind_libunwind_setjmp_LIB_DIRS_RELEASE}>)
        set_property(TARGET libunwind::setjmp APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_setjmp_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET libunwind::setjmp APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_setjmp_COMPILE_OPTIONS_RELEASE}>)
    ...
    ########## COMPONENT libunwind::generic #############
        ...
        set_property(TARGET libunwind::generic APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_generic_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET libunwind::generic APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${libunwind_libunwind_generic_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET libunwind::generic APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${libunwind_libunwind_generic_LIB_DIRS_RELEASE}>)
        set_property(TARGET libunwind::generic APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_generic_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET libunwind::generic APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_generic_COMPILE_OPTIONS_RELEASE}>)
    ...
    ########## COMPONENT libunwind::unwind #############
        ...
        set_property(TARGET libunwind::unwind APPEND PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_unwind_LINKER_FLAGS_RELEASE}>)
        set_property(TARGET libunwind::unwind APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Release>:${libunwind_libunwind_unwind_INCLUDE_DIRS_RELEASE}>)
        set_property(TARGET libunwind::unwind APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Release>:${libunwind_libunwind_unwind_LIB_DIRS_RELEASE}>)
        set_property(TARGET libunwind::unwind APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_unwind_COMPILE_DEFINITIONS_RELEASE}>)
        set_property(TARGET libunwind::unwind APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Release>:${libunwind_libunwind_unwind_COMPILE_OPTIONS_RELEASE}>)

    ########## AGGREGATED GLOBAL TARGET WITH THE COMPONENTS #####################
    set_property(TARGET libunwind::libunwind APPEND PROPERTY INTERFACE_LINK_LIBRARIES libunwind::coredump)
    set_property(TARGET libunwind::libunwind APPEND PROPERTY INTERFACE_LINK_LIBRARIES libunwind::ptrace)
    set_property(TARGET libunwind::libunwind APPEND PROPERTY INTERFACE_LINK_LIBRARIES libunwind::setjmp)
    set_property(TARGET libunwind::libunwind APPEND PROPERTY INTERFACE_LINK_LIBRARIES libunwind::generic)
    set_property(TARGET libunwind::libunwind APPEND PROPERTY INTERFACE_LINK_LIBRARIES libunwind::unwind)

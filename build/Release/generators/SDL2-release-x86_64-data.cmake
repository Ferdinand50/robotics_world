...
if(DEFINED sdl_FIND_DEPENDENCY_NAMES)
  list(APPEND sdl_FIND_DEPENDENCY_NAMES pulseaudio ALSA opengl_system xkbcommon wayland Iconv egl libunwind)
  list(REMOVE_DUPLICATES sdl_FIND_DEPENDENCY_NAMES)
else()
  set(sdl_FIND_DEPENDENCY_NAMES pulseaudio ALSA opengl_system xkbcommon wayland Iconv egl libunwind)
endif()
...
########### VARIABLES #######################################################################
#############################################################################################
set(sdl_PACKAGE_FOLDER_RELEASE "/home/ferdi/.conan2/p/b/sdl9248f3e6e743c/p")
...
set(sdl_SYSTEM_LIBS_RELEASE dl rt pthread)
...
set(sdl_SDL2_SDL2_SYSTEM_LIBS_RELEASE dl rt pthread)
set(sdl_SDL2_SDL2_FRAMEWORK_DIRS_RELEASE )
set(sdl_SDL2_SDL2_FRAMEWORKS_RELEASE )
set(sdl_SDL2_SDL2_DEPENDENCIES_RELEASE Iconv::Iconv ALSA::ALSA pulseaudio::pulseaudio opengl::opengl wayland::wayland xkbcommon::xkbcommon egl::egl libunwind::libunwind)
